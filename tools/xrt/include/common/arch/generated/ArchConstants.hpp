...
enum class ArchConstant : unsigned int {
	...
	PARAMETERS_STOP_ARCHITECTURE = 1605,
	DEBUG_WRITE_MODE_CMD_ARRAY_REREAD_ARRAY_MEM = 1606,
	IO_INTF_AXILITE_WRITE_DEBUG_MEM_READ_ADDR_START_ADDR = 1607,
	IO_INTF_AXILITE_WRITE_DEBUG_MEM_READ_ADDR_STOP_ADDR = 1608,
	XPU_DEBUG_READ_ADDR_START_REG_LOC_LOWER = 1609,
	XPU_DEBUG_READ_ADDR_START_REG_LOC_UPPER = 1610,
	XPU_DEBUG_READ_ADDR_START_REG_NR_BITS = 1611,
	XPU_DEBUG_READ_ADDR_STOP_REG_LOC_LOWER = 1612,
	XPU_DEBUG_READ_ADDR_STOP_REG_LOC_UPPER = 1613,
	XPU_DEBUG_READ_ADDR_STOP_REG_NR_BITS = 1614,
	BOOL_SCAN_OR_NR_PIPELINE_STAGES = 1615,
	PRINT_CONTINOUS_DTE_GENERAL_INFO = 1616,
	HAS_INPUT_DATA_REORDER_BUFFER = 1617,
	INPUT_DATA_REORDER_BUFFER_NR_COLS = 1618,
	INPUT_DATA_REORDER_BUFFER_NR_LINES = 1619,
	IO_INTF_AXILITE_WRITE_REGS_INPUT_DATA_REORDER_BUFFER_FIFO_IN_ADDR = 1620,
	REORDER_BUFFER_COMMAND_NR_BITS = 1621,
	REORDER_BUFFER_COMMAND_NR_COMMANDS = 1622,
	REORDER_BUFFER_COMMAND_PASS_THROUGH = 1623,
	REORDER_BUFFER_COMMAND_REVERSE_ALL = 1624,
	REORDER_BUFFER_COMMAND_REVERSE_COLS = 1625,
	REORDER_BUFFER_COMMAND_REVERSE_LINES = 1626,
	REORDER_BUFFER_COMMAND_TRANSPOSE = 1627,
	REORDER_BUFFER_CONTROL_DATA_ORDER_NR_COLS = 1628,
	REORDER_BUFFER_CONTROL_DATA_ORDER_NR_LINES = 1629,
	REORDER_BUFFER_CONTROL_DATA_ORDER_PREPARE_ADDRESSES = 1630,
	REORDER_BUFFER_CONTROL_DATA_ORDER_TYPE = 1631,
	REORDER_BUFFER_CONTROL_FIFO_NR_BITS = 1632,
	REORDER_BUFFER_NR_CONTROL_DATAS_PER_TRANSACTION = 1633,
	XPU_STATUS_REG_INPUT_DATA_REORDER_BUFFER_ACTIVE_LOWER = 1634,
	XPU_STATUS_REG_INPUT_DATA_REORDER_BUFFER_ACTIVE_NR_BITS = 1635,
	XPU_STATUS_REG_INPUT_DATA_REORDER_BUFFER_ACTIVE_UPPER = 1636,
	REORDER_BUFFER_CONTROL_DATA_ORDER_NONE = 1637,
	REORDER_BUFFER_CONTROL_DATA_ORDER_TYPE_STEP2 = 1638,
	REORDER_BUFFER_COMMAND_REVERSE = 1639,
	HAS_OUTPUT_DATA_REORDER_BUFFER = 1640,
	IO_INTF_AXILITE_WRITE_REGS_OUTPUT_DATA_REORDER_BUFFER_FIFO_IN_ADDR = 1641,
	OUTPUT_DATA_REORDER_BUFFER_NR_COLS = 1642,
	OUTPUT_DATA_REORDER_BUFFER_NR_LINES = 1643,
	XPU_STATUS_REG_OUTPUT_DATA_REORDER_BUFFER_ACTIVE_LOWER = 1644,
	XPU_STATUS_REG_OUTPUT_DATA_REORDER_BUFFER_ACTIVE_NR_BITS = 1645,
	XPU_STATUS_REG_OUTPUT_DATA_REORDER_BUFFER_ACTIVE_UPPER = 1646,
	PRINT_CONTINOUS_REORDER_BUFFER_INPUT = 1647,
	PRINT_CONTINOUS_REORDER_BUFFER_OUTPUT = 1648,
	IO_INTF_AXILITE_READ_REGS_DTE_ALLOW_RA_COUNT = 1649,
	IO_INTF_AXILITE_READ_REGS_DTE_ALLOW_RC_COUNT = 1650,
	IO_INTF_AXILITE_READ_REGS_DTE_ALLOW_WA_COUNT = 1651,
	IO_INTF_AXILITE_READ_REGS_DTE_ALLOW_WC_COUNT = 1652,
	IO_INTF_AXILITE_READ_REGS_DTE_COMMAND_RA_COUNT = 1653,
	IO_INTF_AXILITE_READ_REGS_DTE_COMMAND_RC_COUNT = 1654,
	IO_INTF_AXILITE_READ_REGS_DTE_COMMAND_WA_COUNT = 1655,
	IO_INTF_AXILITE_READ_REGS_DTE_COMMAND_WC_COUNT = 1656,
	IO_INTF_AXILITE_READ_REGS_INPUT_DATA_REORDER_BUFFER_DATA_COUNT = 1657,
	IO_INTF_AXILITE_READ_REGS_OUTPUT_DATA_REORDER_BUFFER_DATA_COUNT = 1658,
	RESOURCE_HAS_INPUT_DATA_REORDER_BUFFER = 1659,
	RESOURCE_HAS_OUTPUT_DATA_REORDER_BUFFER = 1660,
	ARRAY_CELL_FLAGS_ARE_w_REGISTER = 1661,
	BOOL_SCAN_OR_HAS_PIPELINE_REGS = 1662,
	RESOURCE_ARRAY_HAS_BOOL_SCAN_NETWORK = 1663,
	CEVA_TEMP_GUNOI_TEST = 1664,
	ACTIVATION_REG_NR_BITS = 1665,
	ACTIVATION_REG_SIZE = 1666,
	RESOURCE_ACCELERATOR_HAS_DEBUG_VALUE = 1667,
	INSTR_SPATIAL_SELECT_WHERE_COND_WHERELAST = 1668,
	INSTR_SPATIAL_SELECT_WHERE_COND_WHERENLAST = 1669,
	INSTR_SPATIAL_SELECT_WHERE_COND_WHEREN_AFTER_FIRST = 1670,
	INSTR_SPATIAL_SELECT_WHERE_COND_WHEREN_BEFORE_LAST = 1671,
	INSTR_SPATIAL_SELECT_WHERE_COND_WHERE_AFTER_FIRST = 1672,
	INSTR_SPATIAL_SELECT_WHERE_COND_WHERE_BEFORE_LAST = 1673,
	IO_INTF_AXILITE_READ_REGS_DTE_ALLOW_RA_COUNT_ADDR = 1674,
	IO_INTF_AXILITE_READ_REGS_DTE_ALLOW_RC_COUNT_ADDR = 1675,
	IO_INTF_AXILITE_READ_REGS_DTE_ALLOW_WA_COUNT_ADDR = 1676,
	IO_INTF_AXILITE_READ_REGS_DTE_ALLOW_WC_COUNT_ADDR = 1677,
	IO_INTF_AXILITE_READ_REGS_DTE_COMMAND_RA_COUNT_ADDR = 1678,
	IO_INTF_AXILITE_READ_REGS_DTE_COMMAND_RC_COUNT_ADDR = 1679,
	IO_INTF_AXILITE_READ_REGS_DTE_COMMAND_WA_COUNT_ADDR = 1680,
	IO_INTF_AXILITE_READ_REGS_DTE_COMMAND_WC_COUNT_ADDR = 1681,
	IO_INTF_AXILITE_READ_REGS_INPUT_DATA_REORDER_BUFFER_DATA_COUNT_ADDR = 1682,
	IO_INTF_AXILITE_READ_REGS_OUTPUT_DATA_REORDER_BUFFER_DATA_COUNT_ADDR = 1683,
	XPU_HARDWARE_CONFIG_REG20_DEBUG_NR_BREAKPOINTS_NR_BITS = 1684,
	XPU_HARDWARE_CONFIG_REG20_DEBUG_NR_BREAKPOINTS_NR_BITS_LOC_LOWER = 1685,
	XPU_HARDWARE_CONFIG_REG20_DEBUG_NR_BREAKPOINTS_NR_BITS_LOC_UPPER = 1686,
	XPU_HARDWARE_CONFIG_REG20_DEBUG_NR_CONDITIONS_NR_BITS = 1687,
	XPU_HARDWARE_CONFIG_REG20_DEBUG_NR_CONDITIONS_NR_BITS_LOC_LOWER = 1688,
	XPU_HARDWARE_CONFIG_REG20_DEBUG_NR_CONDITIONS_NR_BITS_LOC_UPPER = 1689,
	XPU_HARDWARE_CONFIG_REG20_OCCUPIED_NR_BITS = 1690,
	XPU_HARDWARE_CONFIG_REG20_PADDING_NEEDED_AMOUNT = 1691,
	XPU_HARDWARE_CONFIG_REG21_HAS_INPUT_DATA_REORDER_BUFFER_LOC_LOWER = 1692,
	XPU_HARDWARE_CONFIG_REG21_HAS_INPUT_DATA_REORDER_BUFFER_LOC_UPPER = 1693,
	XPU_HARDWARE_CONFIG_REG21_HAS_INPUT_DATA_REORDER_BUFFER_NR_BITS = 1694,
	XPU_HARDWARE_CONFIG_REG21_HAS_OUTPUT_DATA_REORDER_BUFFER_LOC_LOWER = 1695,
	XPU_HARDWARE_CONFIG_REG21_HAS_OUTPUT_DATA_REORDER_BUFFER_LOC_UPPER = 1696,
	XPU_HARDWARE_CONFIG_REG21_HAS_OUTPUT_DATA_REORDER_BUFFER_NR_BITS = 1697,
	XPU_HARDWARE_CONFIG_REG21_OCCUPIED_NR_BITS = 1698,
	XPU_HARDWARE_CONFIG_REG21_PADDING_NEEDED_AMOUNT = 1699,
	ACCELERATOR_HW_VERSION = 1700,
	IO_INTF_AXILITE_READ_REGS_HW_VERSION_ADDR = 1701,
	IO_INTF_AXISTREAM_DATA_IN_ENDIANNESS_words_per_packet_EXTERNAL = 1702,
	IO_INTF_AXISTREAM_DATA_IN_ENDIANNESS_words_per_packet_INTERNAL = 1703,
	IO_INTF_AXISTREAM_DATA_OUT_ENDIANNESS_words_per_packet_EXTERNAL = 1704,
	IO_INTF_AXISTREAM_DATA_OUT_ENDIANNESS_words_per_packet_INTERNAL = 1705,
};

extern const std::unordered_map<std::string_view, ArchConstant> archConstantLookup;

constexpr std::size_t cArchNumConstants = 1706;
