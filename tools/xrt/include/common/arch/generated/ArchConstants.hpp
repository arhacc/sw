...
enum class ArchConstant : unsigned int {
    ...
    DEBUG_WRITE_MODE_CMD_ARRAY_REREAD_ARRAY_MEM                                         = 1605,
    IO_INTF_AXILITE_WRITE_DEBUG_MEM_READ_ADDR_START_ADDR                                = 1606,
    IO_INTF_AXILITE_WRITE_DEBUG_MEM_READ_ADDR_STOP_ADDR                                 = 1607,
    PARAMETERS_STOP_ARCHITECTURE                                                        = 1608,
...
constexpr std::size_t cArchNumConstants = 1615;
