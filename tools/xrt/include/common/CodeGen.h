...
//-------------------------------------------------------------------------------------
static inline
constexpr uint8_t makeInstructionByte(const Arch &_arch, uint8_t _opcode, uint8_t _operand) {
...
//-------------------------------------------------------------------------------------
static inline
constexpr uint32_t makeInstruction(const Arch &_arch, uint8_t _instructionByte, uint32_t _argument) {
...
//-------------------------------------------------------------------------------------
static inline
constexpr uint32_t makeJumpInstruction(const Arch &_arch, uint8_t _instructionByte, uint8_t _jmpFunction, uint8_t _valReg, uint16_t _value) {
