...
class Target {
  public:
    ...
    virtual void
    runDebug(uint32_t _address, uint32_t* _args, uint32_t _breakpointAddress) = 0;

    virtual void readControllerData(
        uint32_t _address,
        uint32_t* _data,
        uint32_t _lineStart,
        uint32_t _lineStop,
    ...
    virtual void writeControllerData(
        uint32_t _address,
        uint32_t* _data,
        uint32_t _lineStart,
        uint32_t _lineStop,
