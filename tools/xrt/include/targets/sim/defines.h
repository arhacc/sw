...
// possible problems if instr (total) becomes more than 32b, because of "prog" io
// interface
...
#define ARRAY_INDEX_NR_BITS (log2(ARRAY_NR_CELLS))

#define ARRAY_CELL_MEM_NR_BITS (log2(ARRAY_CELL_MEM_SIZE))
// ^ + ^^ data mem

#define CONTROLLER_MEM_NR_BITS (log2(CONTROLLER_MEM_SIZE))
// ^ + ^^ data mem

#define CONTROLLER_INSTR_MEM_NR_BITS (log2(CONTROLLER_INSTR_MEM_SIZE))
...
// ^ interfata cu arm; pt fifo-uri; currently, data is combined outside the array on the
// proper size;
#define IO_INTERNAL_DATA_INTERFACE_NR_INTERFACES (NR_PARTIAL_MULTICELLS_PER_MULTICELL)
// ^ intre multicells

#define DISTRIBUTE_NET_OUTER_MULTICELL_DEPTH (log2(NR_MULTICELLS))
#define DISTRIBUTE_NET_INNER_MULTICELL_DEPTH (log2(NR_PARTIAL_MULTICELLS_PER_MULTICELL))
#define DISTRIBUTE_NET_INNER_PARTIAL_MULTICELL_DEPTH \
    (log2(NR_CELLS_PER_PARTIAL_MULTICELL))

#define DISTRIBUTE_NET_OUTER_MULTICELL_NR_PIPELINE_REGS \
    (DISTRIBUTE_NET_OUTER_MULTICELL_DEPTH)
#define DISTRIBUTE_NET_INNER_MULTICELL_NR_PIPELINE_REGS \
    (DISTRIBUTE_NET_INNER_MULTICELL_DEPTH)
#define DISTRIBUTE_NET_INNER_PARTIAL_MULTICELL_NR_PIPELINE_REGS (0)
// ^^^+^^ changeable if desired; 			^ needs to be 0 for io propagation
// synchronization

#define DISTRIBUTE_NET_TOTAL_DEPTH                                               \
    (DISTRIBUTE_NET_OUTER_MULTICELL_DEPTH + DISTRIBUTE_NET_INNER_MULTICELL_DEPTH \
     + DISTRIBUTE_NET_INNER_PARTIAL_MULTICELL_DEPTH)
#define DISTRIBUTE_NET_TOTAL_NR_PIPELINE_REGS          \
...
#define IO_INTF_PROG_AXILITE_DATA_SIZE \
    ((IO_INTF_PROG_NR_BITS >= 32) ? IO_INTF_PROG_NR_BITS : 32)
...
#define IO_INTF_AXILITE_WRITE_REGS_INT_ACK_ADDR \
    (IO_INTF_AXILITE_WRITE_REGS_PROG_FIFO_IN_ADDR + IO_INTF_AXILITE_ADDR_STEP)

#define IO_INTF_AXILITE_READ_REGS_STATUS_REG_ADDR (0)
#define IO_INTF_AXILITE_READ_REGS_PROGRAM_COUNTER_REG_ADDR \
    (IO_INTF_AXILITE_READ_REGS_STATUS_REG_ADDR + IO_INTF_AXILITE_ADDR_STEP)
#define IO_INTF_AXILITE_READ_REGS_CYCLE_COUNTER_REG_ADDR \
    (IO_INTF_AXILITE_READ_REGS_PROGRAM_COUNTER_REG_ADDR + IO_INTF_AXILITE_ADDR_STEP)
#define IO_INTF_AXILITE_READ_REGS_ACCELERATOR_ID_REG_ADDR \
    (IO_INTF_AXILITE_READ_REGS_CYCLE_COUNTER_REG_ADDR + IO_INTF_AXILITE_ADDR_STEP)
#define IO_INTF_AXILITE_READ_REGS_CONTROLLER_ACC_REG_ADDR \
    (IO_INTF_AXILITE_READ_REGS_ACCELERATOR_ID_REG_ADDR + IO_INTF_AXILITE_ADDR_STEP)
#define IO_INTF_AXILITE_READ_REGS_FIFO_PROG_DATA_COUNT_REG_ADDR \
    (IO_INTF_AXILITE_READ_REGS_CONTROLLER_ACC_REG_ADDR + IO_INTF_AXILITE_ADDR_STEP)
#define IO_INTF_AXILITE_READ_REGS_FIFO_DATA_IN_DATA_COUNT_REG_ADDR \
    (IO_INTF_AXILITE_READ_REGS_FIFO_PROG_DATA_COUNT_REG_ADDR + IO_INTF_AXILITE_ADDR_STEP)
#define IO_INTF_AXILITE_READ_REGS_FIFO_DATA_OUT_DATA_COUNT_REG_ADDR \
    (IO_INTF_AXILITE_READ_REGS_FIFO_DATA_IN_DATA_COUNT_REG_ADDR     \
     + IO_INTF_AXILITE_ADDR_STEP)

#define IO_INTF_AXILITE_NR_WRITE_REGS \
    ((IO_INTF_AXILITE_WRITE_REGS_INT_ACK_ADDR / IO_INTF_AXILITE_ADDR_STEP) + 1)
#define IO_INTF_AXILITE_NR_READ_REGS                              \
...
#define XPU_STATUS_REG_PROG_FIFO_EMPTY_LOC_UPPER \
    XPU_STATUS_REG_PROG_FIFO_EMPTY_LOC_LOWER + XPU_STATUS_REG_PROG_FIFO_EMPTY_NR_BITS - 1
#define XPU_STATUS_REG_PROG_FIFO_FULL_LOC_LOWER \
    XPU_STATUS_REG_PROG_FIFO_EMPTY_LOC_UPPER + 1
#define XPU_STATUS_REG_PROG_FIFO_FULL_LOC_UPPER \
    XPU_STATUS_REG_PROG_FIFO_FULL_LOC_LOWER + XPU_STATUS_REG_PROG_FIFO_FULL_NR_BITS - 1
#define XPU_STATUS_REG_DATA_IN_FIFO_EMPTY_LOC_LOWER \
...
#define IO_DATA_FIFO_DATA_OUT_TLAST_BITS_LOC_UPPER \
    IO_DATA_FIFO_DATA_OUT_TLAST_BITS_LOC_LOWER + IO_DATA_FIFO_DATA_OUT_TLAST_NR_BITS - 1
#define IO_DATA_FIFO_DATA_OUT_DATA_BITS_LOC_LOWER \
    IO_DATA_FIFO_DATA_OUT_TLAST_BITS_LOC_UPPER + 1
#define IO_DATA_FIFO_DATA_OUT_DATA_BITS_LOC_UPPER                                       \
    IO_DATA_FIFO_DATA_OUT_DATA_BITS_LOC_LOWER + IO_DATA_FIFO_DATA_OUT_DATA_BITS_NR_BITS \
        - 1

#define IO_DATA_FIFO_DATA_OUT_DATA_BITS_LOC    \
    IO_DATA_FIFO_DATA_OUT_DATA_BITS_LOC_UPPER: \
    IO_DATA_FIFO_DATA_OUT_DATA_BITS_LOC_LOWER
#define IO_DATA_FIFO_DATA_OUT_TLAST_BITS_LOC    \
...
#define IO_DATA_OUT_FIFO_DATA_SIZE \
    (IO_DATA_FIFO_DATA_OUT_TLAST_NR_BITS + IO_DATA_FIFO_DATA_OUT_DATA_BITS_NR_BITS)
...
// percentage works while within min/max limits for threshold as defined in ug953 /
// XPM_FIFO_SYNC
// https://docs.xilinx.com/r/en-US/ug953-vivado-7series-libraries/XPM_FIFO_SYNC
#define IO_DATA_FIFO_programable_EMPTY_THRESHOLD_DESIRED_VALUE \
    (IO_DATA_FIFO_SIZE * IO_DATA_FIFO_programable_EMPTY_THRESHOLD_PERCENTAGE / 100)
#define IO_DATA_FIFO_programable_FULL_THRESHOLD_DESIRED_VALUE \
    (IO_DATA_FIFO_SIZE * IO_DATA_FIFO_programable_FULL_THRESHOLD_PERCENTAGE / 100)

#define IO_DATA_FIFO_programable_EMPTY_THRESHOLD                                        \
    (IO_DATA_FIFO_programable_EMPTY_THRESHOLD_DESIRED_VALUE < (3 + 1 * 2) ? (3 + 1 * 2) \
     : IO_DATA_FIFO_programable_EMPTY_THRESHOLD_DESIRED_VALUE                           \
             > (IO_DATA_FIFO_SIZE - 3) - (1 * 2)                                        \
         ? (IO_DATA_FIFO_SIZE - 3) - (1 * 2)                                            \
         : IO_DATA_FIFO_programable_EMPTY_THRESHOLD_DESIRED_VALUE)
#define IO_DATA_FIFO_programable_FULL_THRESHOLD                                        \
    (IO_DATA_FIFO_programable_FULL_THRESHOLD_DESIRED_VALUE                             \
             < 3 + (1 * 2 * (IO_DATA_FIFO_SIZE / IO_DATA_FIFO_SIZE))                   \
         ? 3 + (1 * 2 * (IO_DATA_FIFO_SIZE / IO_DATA_FIFO_SIZE))                       \
     : IO_DATA_FIFO_programable_FULL_THRESHOLD_DESIRED_VALUE                           \
             > (IO_DATA_FIFO_SIZE - 3)                                                 \
                   - (1 * 2 * (IO_DATA_FIFO_SIZE / IO_DATA_FIFO_SIZE))                 \
...
// XPM_FIFO_SYNC
// https://docs.xilinx.com/r/en-US/ug953-vivado-7series-libraries/XPM_FIFO_SYNC
#define IO_PROG_FIFO_programable_EMPTY_THRESHOLD_DESIRED_VALUE \
    (IO_PROG_FIFO_SIZE * IO_PROG_FIFO_programable_EMPTY_THRESHOLD_PERCENTAGE / 100)
#define IO_PROG_FIFO_programable_FULL_THRESHOLD_DESIRED_VALUE \
    (IO_PROG_FIFO_SIZE * IO_PROG_FIFO_programable_FULL_THRESHOLD_PERCENTAGE / 100)

#define IO_PROG_FIFO_programable_EMPTY_THRESHOLD                                        \
    (IO_PROG_FIFO_programable_EMPTY_THRESHOLD_DESIRED_VALUE < (3 + 1 * 2) ? (3 + 1 * 2) \
     : IO_PROG_FIFO_programable_EMPTY_THRESHOLD_DESIRED_VALUE                           \
             > (IO_PROG_FIFO_SIZE - 3) - (1 * 2)                                        \
         ? (IO_PROG_FIFO_SIZE - 3) - (1 * 2)                                            \
         : IO_PROG_FIFO_programable_EMPTY_THRESHOLD_DESIRED_VALUE)
#define IO_PROG_FIFO_programable_FULL_THRESHOLD                                        \
    (IO_PROG_FIFO_programable_FULL_THRESHOLD_DESIRED_VALUE                             \
             < 3 + (1 * 2 * (IO_PROG_FIFO_SIZE / IO_PROG_FIFO_SIZE))                   \
         ? 3 + (1 * 2 * (IO_PROG_FIFO_SIZE / IO_PROG_FIFO_SIZE))                       \
     : IO_PROG_FIFO_programable_FULL_THRESHOLD_DESIRED_VALUE                           \
             > (IO_PROG_FIFO_SIZE - 3)                                                 \
                   - (1 * 2 * (IO_PROG_FIFO_SIZE / IO_PROG_FIFO_SIZE))                 \
...
#define CTRL_MEM_MEMCOM_CMD_LOC_UPPER \
    CTRL_MEM_MEMCOM_CMD_SIZE_unguarded + CTRL_MEM_MEMCOM_OP_SIZE_unguarded - 1
...
#define CTRL_MEM_MEMCOM_CMD_LOC    \
    CTRL_MEM_MEMCOM_CMD_LOC_UPPER: \
    CTRL_MEM_MEMCOM_CMD_LOC_LOWER
#define CTRL_MEM_MEMCOM_OP_LOC    \
    CTRL_MEM_MEMCOM_OP_LOC_UPPER: \
    CTRL_MEM_MEMCOM_OP_LOC_LOWER
#define CTRL_MEM_MEMCOM_CMD_MEM_NONE(x, delimiter) \
    (x##delimiter##d0) // delimiter is ' and x = CTRL_MEM_MEMCOM_CMD_SIZE_unguarded
...
#define CTRL_MEM_MEMCOM_CMD_MEM_LOAD_STORE_REG_ADD \
    (CTRL_MEM_MEMCOM_CMD_MEM_LOAD_STORE + 1)
#define CTRL_MEM_MEMCOM_CMD_MEM_LOAD_ADDR_REG_ADD \
    (CTRL_MEM_MEMCOM_CMD_MEM_LOAD_STORE_REG_ADD + 1)
#define CTRL_MEM_MEMCOM_CMD_MEM_STORE_ADDR_REG_ADD \
    (CTRL_MEM_MEMCOM_CMD_MEM_LOAD_ADDR_REG_ADD + 1)

#define ARRAY_MEM_MEMCOM_SIZE_unguarded 2
#define ARRAY_MEM_MEMCOM_SIZE           (ARRAY_MEM_MEMCOM_SIZE_unguarded)
#define ARRAY_MEM_MEMCOM_CMD_NONE(x, delimiter) \
    "x##delimiter##d0" // x = ARRAY_MEM_MEMCOM_SIZE_unguarded
...
#define ARRAY_STACK_CMD_SIZE (log2(ARRAY_STACK_NR_CMD) + 1)
...
#define CTRL_STACK_CMD_SIZE (log2(CTRL_STACK_NR_CMD) + 1)
...
#define ISA_stack_operations_CTL_val_nr_bits \
    (log2(ISA_stack_operations_CTL_val_LOAD_LAYRER1 + 1) + 1)
...
#define ISA_stack_operations_CTL_val_LOC    \
...
undef RESOURCE_ARRAY_HAS_BW_SCAN_NET undef RESOURCE_ARRAY_HAS_REDUCE_NET
#endif
#endif
#endif
#endif
...
#define NETWORK_NR_OPERATIONS                                                  \
    (NET_HAS_OPERATION_NOP + NET_HAS_OPERATION_ADD + NET_HAS_OPERATION_SUB     \
     ...
     + NET_HAS_OPERATION_bitwise_OR + NET_HAS_OPERATION_bitwise_AND            \
     + NET_HAS_OPERATION_bitwise_XOR)

#define NETWORK_WIDTH (ARRAY_NR_CELLS / 2)
//^ measured in cells
#define NETWORK_NR_INPUTS (NETWORK_WIDTH * 2)
#define NETWORK_DEPTH     (log2(NETWORK_NR_INPUTS) * 2 - 1)
//^ measured in cells
#define NETWORK_SCAN_ENABLE_SIZE (log2(NETWORK_NR_INPUTS))
#define NETWORK_BW_BITS_SIZE     (NETWORK_DEPTH)
#define NETWORK_NR_OPCODE_BITS \
    (log2((NETWORK_NR_OPERATIONS < 2) ? 2 : NETWORK_NR_OPERATIONS))
...
#define NETWORK_SCAN_MODE_CONTINOUS_LOAD_SHIFT_REG \
    (NETWORK_SCAN_MODE_CONTINOUS_LOAD_MEM_OUT + 1)
#define NETWORK_SCAN_MODE_ONE_SHOT_LOAD_MEM_OUT \
    (NETWORK_SCAN_MODE_CONTINOUS_LOAD_SHIFT_REG + 1)
#define NETWORK_SCAN_MODE_ONE_SHOT_LOAD_SHIFT_REG \
    (NETWORK_SCAN_MODE_ONE_SHOT_LOAD_MEM_OUT + 1)
#define NETWORK_SCAN_MODES         (NETWORK_SCAN_MODE_ONE_SHOT_LOAD_SHIFT_REG + 1)
#define NETWORK_SCAN_MODES_NR_BITS (log2(NETWORK_SCAN_MODES) + 1)
...
#define NETWORK_OP_bitwise_XOR \
    (NETWORK_OP_bitwise_AND + NET_HAS_OPERATION_bitwise_XOR * 1)
...
#define ARRAY_CELL_SHIFT_MSBSEL_NR_BITS (log2(ARRAY_CELL_SHIFT_MSBSEL_NR) + 1)
...
#define ARRAY_CELL_OPSEL_sel_GLOBAL_SHIFT_REG \
    (ARRAY_CELL_OPSEL_sel_SHR1 + HAS_ARRAY_CELL_OPSEL_sel_GLOBAL_SHIFT_REG * 1)
#define ARRAY_CELL_OPSEL_sel_SCANOUT \
    (ARRAY_CELL_OPSEL_sel_GLOBAL_SHIFT_REG + 1 * HAS_ARRAY_CELL_OPSEL_sel_SCANOUT)
#define ARRAY_CELL_OPSEL_sel_ROT_SH_OUT \
    (ARRAY_CELL_OPSEL_sel_SCANOUT + HAS_ARRAY_CELL_OPSEL_sel_ROT_SH_OUT * 1)
#define ARRAY_CELL_OPSEL_sel_STACK_LAYER1 \
    (ARRAY_CELL_OPSEL_sel_ROT_SH_OUT + HAS_ARRAY_CELL_OPSEL_sel_STACK_LAYER1 * 1)
#define ARRAY_CELL_OPSEL_sel_SHR_FIXED_AMOUNT \
    (ARRAY_CELL_OPSEL_sel_STACK_LAYER1 + HAS_ARRAY_CELL_OPSEL_sel_SHR_FIXED_AMOUNT * 1)
#define ARRAY_CELL_OPSEL_sel_FLOAT_MANTISSA \
    (ARRAY_CELL_OPSEL_sel_SHR_FIXED_AMOUNT + HAS_ARRAY_CELL_OPSEL_sel_FLOATING_POINT * 1)

#define ARRAY_CELL_OPSEL_NR_OPSEL (ARRAY_CELL_OPSEL_sel_FLOAT_MANTISSA + 1)
#define ARRAY_CELL_OPSEL_NR_BITS  (log2(ARRAY_CELL_OPSEL_NR_OPSEL) + 1)

#define ARRAY_CELL_COMMAND_addrLoad_NR_BITS_unguarded 3
#define ARRAY_CELL_COMMAND_addrLoad_NR_BITS \
    (ARRAY_CELL_COMMAND_addrLoad_NR_BITS_unguarded)
#define ARRAY_CELL_COMMAND_addrLoad_NR_BITS_LOC_UPPER \
    ARRAY_CELL_COMMAND_addrLoad_NR_BITS_unguarded - 1
#define ARRAY_CELL_COMMAND_addrLoad_NR_BITS_LOC_LOWER 0
#define ARRAY_CELL_COMMAND_addrLoad_NR_BITS_LOC    \
...
#define CTRL_SHIFT_MSBSEL_NR_BITS (log2(CTRL_SHIFT_MSBSEL_NR) + 1)
...
#define CTRL_OPSEL_sel_FLOAT_MANTISSA \
    (CTRL_OPSEL_sel_SHR_FIXED_AMOUNT + HAS_CTRL_OPSEL_sel_FLOATING_POINT * 1)
...
#define DTE_PARAM_FIFO_ADDR_NR_BITS \
    (log2(DTE_NR_PARAMETERS_PER_COMMAND * DTE_FIFO_SIZE_NR_COMMANDS) + 1)
#define DTE_PARAM_NR_BITS (IO_INTF_PROG_NR_BITS)
#define DTE_COLUMN_COUNTER_NR_BITS \
    (log2(NR_MULTICELLS * NR_PARTIAL_MULTICELLS_PER_MULTICELL) + 1)
...
#define DTE_CMD_REG_OPCODE_LOC_UPPER \
    DTE_CMD_REG_OPCODE_NR_BITS + DTE_CMD_REG_READ_FLAG_NR_BITS - 1
#define DTE_CMD_REG_OPCODE_LOC_LOWER DTE_CMD_REG_READ_FLAG_NR_BITS

#define DTE_CMD_REG_READ_FLAG_LOC    \
    DTE_CMD_REG_READ_FLAG_LOC_UPPER: \
    DTE_CMD_REG_READ_FLAG_LOC_LOWER
#define DTE_CMD_REG_OPCODE_LOC    \
    DTE_CMD_REG_OPCODE_LOC_UPPER: \
    DTE_CMD_REG_OPCODE_LOC_LOWER
...
#define INSTR_OPERAND_LOC_LOWER INSTR_VALUE_NR_BITS
#define INSTR_OPCODE_LOC_UPPER \
    INSTR_OPCODE_NR_BITS + INSTR_OPERAND_NR_BITS + INSTR_VALUE_NR_BITS - 1
#define INSTR_OPCODE_LOC_LOWER INSTR_OPERAND_NR_BITS + INSTR_VALUE_NR_BITS

#define INSTR_VALUE_LOC    \
    INSTR_VALUE_LOC_UPPER: \
    INSTR_VALUE_LOC_LOWER
#define INSTR_OPERAND_LOC    \
    INSTR_OPERAND_LOC_UPPER: \
    INSTR_OPERAND_LOC_LOWER
#define INSTR_OPCODE_LOC    \
    INSTR_OPCODE_LOC_UPPER: \
...
#define INSTR_OPCODE_LOC_START \
    INSTR_OPCODE_NR_BITS + INSTR_OPERAND_NR_BITS + INSTR_VALUE_NR_BITS
// ^ controller
...
#define INSTR_ARRAY_OPERAND_LOC    \
    INSTR_ARRAY_OPERAND_LOC_UPPER: \
    INSTR_ARRAY_OPERAND_LOC_LOWER
#define INSTR_ARRAY_OPCODE_LOC    \
    INSTR_ARRAY_OPCODE_LOC_UPPER: \
    INSTR_ARRAY_OPCODE_LOC_LOWER
// ^ array; split like this because in array {opcode,operand} and "scalar_value" are
// separate
...
#define INSTR_ARRAY_LOC    \
    INSTR_ARRAY_LOC_UPPER: \
    INSTR_ARRAY_LOC_LOWER
#define INSTR_CONTROLLER_LOC    \
    INSTR_CONTROLLER_LOC_UPPER: \
    INSTR_CONTROLLER_LOC_LOWER
...
#define INSTR_SPATIAL_SELECT_FUNCTION_ENDWHERE \
    (INSTR_SPATIAL_SELECT_FUNCTION_ELSEWHERE + 1)

#define INSTR_SPATIAL_SELECT_WHERE_COND_WHERENZERO (0)
#define INSTR_SPATIAL_SELECT_WHERE_COND_WHEREZERO \
    (INSTR_SPATIAL_SELECT_WHERE_COND_WHERENZERO + 1)
#define INSTR_SPATIAL_SELECT_WHERE_COND_WHERENCARRY \
    (INSTR_SPATIAL_SELECT_WHERE_COND_WHEREZERO + 1)
#define INSTR_SPATIAL_SELECT_WHERE_COND_WHERECARRY \
    (INSTR_SPATIAL_SELECT_WHERE_COND_WHERENCARRY + 1)
#define INSTR_SPATIAL_SELECT_WHERE_COND_WHERESGN \
    (INSTR_SPATIAL_SELECT_WHERE_COND_WHERECARRY + 1)
#define INSTR_SPATIAL_SELECT_WHERE_COND_WHERENSGN \
    (INSTR_SPATIAL_SELECT_WHERE_COND_WHERESGN + 1)
#define INSTR_SPATIAL_SELECT_WHERE_COND_WHERENFIRST \
    (INSTR_SPATIAL_SELECT_WHERE_COND_WHERENSGN + 1)
#define INSTR_SPATIAL_SELECT_WHERE_COND_WHEREFIRST \
    (INSTR_SPATIAL_SELECT_WHERE_COND_WHERENFIRST + 1)
#define INSTR_SPATIAL_SELECT_WHERE_COND_WHERENNEXT \
    (INSTR_SPATIAL_SELECT_WHERE_COND_WHEREFIRST + 1)
#define INSTR_SPATIAL_SELECT_WHERE_COND_WHERENEXT \
    (INSTR_SPATIAL_SELECT_WHERE_COND_WHERENNEXT + 1)
#define INSTR_SPATIAL_SELECT_WHERE_COND_WHERENPREV \
    (INSTR_SPATIAL_SELECT_WHERE_COND_WHERENEXT + 1)
#define INSTR_SPATIAL_SELECT_WHERE_COND_WHEREPREV \
    (INSTR_SPATIAL_SELECT_WHERE_COND_WHERENPREV + 1)

#define INSTR_SPATIAL_SELECT_FUNCTION_NR_BITS \
    (log2(INSTR_SPATIAL_SELECT_FUNCTION_ENDWHERE + 1) + 1)
#define INSTR_SPATIAL_SELECT_WHERE_COND_NR_CONDITIONS \
    (INSTR_SPATIAL_SELECT_WHERE_COND_WHEREPREV + 1)
#define INSTR_SPATIAL_SELECT_WHERE_COND_NR_BITS \
    (log2(INSTR_SPATIAL_SELECT_WHERE_COND_NR_CONDITIONS) + 1)
...
#define INSTR_SPATIAL_SELECT_WHERE_COND_LOC_UPPER \
    INSTR_SPATIAL_SELECT_WHERE_COND_NR_BITS + INSTR_SPATIAL_SELECT_FUNCTION_NR_BITS - 1
#define INSTR_SPATIAL_SELECT_WHERE_COND_LOC_LOWER INSTR_SPATIAL_SELECT_FUNCTION_NR_BITS

#define INSTR_SPATIAL_SELECT_FUNCTION_LOC    \
    INSTR_SPATIAL_SELECT_FUNCTION_LOC_UPPER: \
    INSTR_SPATIAL_SELECT_FUNCTION_LOC_LOWER
#define INSTR_SPATIAL_SELECT_WHERE_COND_LOC    \
...
#define INSTR_MISC_TESTING_SEL_CC_START_WO_HALT \
    (INSTR_MISC_TESTING_SEL_CC_START_W_HALT + 1)
...
#define INSTR_MISC_TESTING_SEL_NR_BITS   (log2(INSTR_MISC_TESTING_SEL_CC_RESET + 1) + 1)
#define INSTR_MISC_TESTING_SEL_LOC_UPPER INSTR_MISC_TESTING_SEL_NR_BITS - 1
#define INSTR_MISC_TESTING_SEL_LOC_LOWER 0
#define INSTR_MISC_TESTING_SEL_LOC    \
    INSTR_MISC_TESTING_SEL_LOC_UPPER: \
    INSTR_MISC_TESTING_SEL_LOC_LOWER
...
#define INSTR_FIXED_SHIFTING_NR_BITS \
    (log2(INSTR_SHIFT_RIGHT_FIXED_AMOUNT_ARITHMETIC + 1) + 1)
#define INSTR_FIXED_SHIFTING_LOC_UPPER INSTR_FIXED_SHIFTING_NR_BITS - 1
#define INSTR_FIXED_SHIFTING_LOC_LOWER 0
#define INSTR_FIXED_SHIFTING_LOC    \
    INSTR_FIXED_SHIFTING_LOC_UPPER: \
    INSTR_FIXED_SHIFTING_LOC_LOWER
...
#define INSTR_MISC_STORE_LOAD_set_addrreg_selector \
    (INSTR_MISC_STORE_LOAD_set_compare_value + 1)
#define INSTR_MISC_STORE_LOAD_array_addr_reg_stack_duplicate \
    (INSTR_MISC_STORE_LOAD_set_addrreg_selector + 1)
#define INSTR_MISC_STORE_LOAD_array_addr_reg_stack_pop \
    (INSTR_MISC_STORE_LOAD_array_addr_reg_stack_duplicate + 1)

#define INSTR_MISC_STORE_LOAD_NR_BITS \
    (log2(INSTR_MISC_STORE_LOAD_array_addr_reg_stack_pop + 1) + 1)
#define INSTR_MISC_STORE_LOAD_VALUE_NR_BITS \
    (INSTR_VALUE_NR_BITS - INSTR_MISC_STORE_LOAD_NR_BITS)
...
#define INSTR_MISC_STORE_LOAD_LOC    \
    INSTR_MISC_STORE_LOAD_LOC_UPPER: \
    INSTR_MISC_STORE_LOAD_LOC_LOWER
#define INSTR_MISC_STORE_LOAD_VALUE_LOC    \
...
#define INSTR_GLOBAL_NR_BITS   (log2(INSTR_GLOBAL_RIGHT_RED_INS + 1) + 1)
#define INSTR_GLOBAL_LOC_UPPER INSTR_GLOBAL_NR_BITS - 1
#define INSTR_GLOBAL_LOC_LOWER 0
#define INSTR_GLOBAL_LOC    \
    INSTR_GLOBAL_LOC_UPPER: \
    INSTR_GLOBAL_LOC_LOWER

// array local shift/rotate
#define INSTR_SH_ROTATE_LOCAL_AMOUNT_NR_BITS_unguarded      log2(DATA_SIZE)
#define INSTR_SH_ROTATE_LOCAL_SPLIT_POINT_NR_BITS_unguarded log2(DATA_SIZE)
#define INSTR_SH_ROTATE_LOCAL_AMOUNT_NR_BITS \
    (INSTR_SH_ROTATE_LOCAL_AMOUNT_NR_BITS_unguarded)
#define INSTR_SH_ROTATE_LOCAL_SPLIT_POINT_NR_BITS \
    (INSTR_SH_ROTATE_LOCAL_SPLIT_POINT_NR_BITS_unguarded)
#define INSTR_SH_ROTATE_LOCAL_CTRL_BITS_NR_BITS_unguarded 2
#define INSTR_SH_ROTATE_LOCAL_CTRL_BITS_NR_BITS \
...
#define INSTR_SH_ROTATE_LOCAL_SPLIT_POINT_LOC_LOWER \
    INSTR_VALUE_LOC_START - 2 + 1 - INSTR_SH_ROTATE_LOCAL_SPLIT_POINT_NR_BITS
#define INSTR_SH_ROTATE_LOCAL_SHIFT_AMOUNT_LOC_UPPER \
    INSTR_VALUE_LOC_START - 2 + 1 - INSTR_SH_ROTATE_LOCAL_SPLIT_POINT_NR_BITS - 1
#define INSTR_SH_ROTATE_LOCAL_SHIFT_AMOUNT_LOC_LOWER                              \
    INSTR_VALUE_LOC_START - 2 + 1 - INSTR_SH_ROTATE_LOCAL_SPLIT_POINT_NR_BITS - 1 \
        - INSTR_SH_ROTATE_LOCAL_AMOUNT_NR_BITS + 1

#define INSTR_SH_ROTATE_LOCAL_DIRECTION_BIT_LOC    \
    INSTR_SH_ROTATE_LOCAL_DIRECTION_BIT_LOC_UPPER: \
    INSTR_SH_ROTATE_LOCAL_DIRECTION_BIT_LOC_LOWER
#define INSTR_SH_ROTATE_LOCAL_MODE_BIT_LOC    \
    INSTR_SH_ROTATE_LOCAL_MODE_BIT_LOC_UPPER: \
    INSTR_SH_ROTATE_LOCAL_MODE_BIT_LOC_LOWER
#define INSTR_SH_ROTATE_LOCAL_SPLIT_POINT_LOC    \
    INSTR_SH_ROTATE_LOCAL_SPLIT_POINT_LOC_UPPER: \
    INSTR_SH_ROTATE_LOCAL_SPLIT_POINT_LOC_LOWER
#define INSTR_SH_ROTATE_LOCAL_SHIFT_AMOUNT_LOC    \
...
#define INSTR_SH_ROT_CTRL_bits_DONT_CARE(x, delimiter) \
    "x##delimiter##b00" // x = INSTR_SH_ROTATE_LOCAL_CTRL_BITS_NR_BITS_unguarded
#define INSTR_SH_ROT_CTRL_bits_LEFT_SHIFT(x, delimiter) \
    "x##delimiter##b00" // x = INSTR_SH_ROTATE_LOCAL_CTRL_BITS_NR_BITS_unguarded
#define INSTR_SH_ROT_CTRL_bits_RIGHT_SHIFT(x, delimiter) \
    "x##delimiter##b10" // x = INSTR_SH_ROTATE_LOCAL_CTRL_BITS_NR_BITS_unguarded
#define INSTR_SH_ROT_CTRL_bits_LEFT_ROTATE(x, delimiter) \
    "x##delimiter##b01" // x = INSTR_SH_ROTATE_LOCAL_CTRL_BITS_NR_BITS_unguarded
#define INSTR_SH_ROT_CTRL_bits_RIGHT_ROTATE(x, delimiter) \
    "x##delimiter##b11" // x = INSTR_SH_ROTATE_LOCAL_CTRL_BITS_NR_BITS_unguarded
...
#define INSTR_SETSCAN_ADDR_MODE_LOC_UPPER \
    NETWORK_NR_OPCODE_BITS + NETWORK_SCAN_MODES_NR_BITS - 1
#define INSTR_SETSCAN_ADDR_MODE_LOC_LOWER NETWORK_NR_OPCODE_BITS

#define INSTR_SETSCAN_OPCODE_LOC    \
    INSTR_SETSCAN_OPCODE_LOC_UPPER: \
    INSTR_SETSCAN_OPCODE_LOC_LOWER
#define INSTR_SETSCAN_ADDR_MODE_LOC    \
...
#define INSTR_JMP_FUNCTION_NR_BITS_unguarded (log2(INSTR_JMP_FUNCTION_NR_FUNCTIONS) + 1)
#define INSTR_JMP_VALUE_NR_BITS_unguarded \
    INSTR_VALUE_NR_BITS_unguarded - INSTR_JMP_FUNCTION_NR_BITS_unguarded
...
#define INSTR_JMP_VALUE_LOC    \
    INSTR_JMP_VALUE_LOC_UPPER: \
    INSTR_JMP_VALUE_LOC_LOWER
#define INSTR_JMP_FUNCTION_LOC    \
    INSTR_JMP_FUNCTION_LOC_UPPER: \
    INSTR_JMP_FUNCTION_LOC_LOWER

// float instuction - steps in float calculations
/*
FLOAT(0): acc <= acc efOp  mantReg
old:	FLOAT(5) FLOAT(+1): acc(in 2's complement) <= {sgn, positiveInteger}
FLOAT(6) FLOAT(+1): exponent <= exponent - (23 - PE(acc))/ exponent + 1
FLOAT(7) FLOAT(+1): acc <= {sgn, exp, frac}
FLOAT(8) FLOAT(+1): acc <= {sgn, exponent, frac(acc)}
FLOAT(9) FLOAT(+1): acc <= mantReg
FLOAT(10) FLOAT(+1): exponent <= exponent - (23 - PE(acc))/ exponent + 1
FLOAT(11)
//*/
...
#define ARRAY_ALUCOM_ALUFUNC_POS_UPPER \
    ARRAY_ALUCOM_CR_IN_NR_BITS + ARRAY_ALUCOM_ALUFUNC_NR_BITS - 1
#define ARRAY_ALUCOM_ALUFUNC_POS_LOWER ARRAY_ALUCOM_CR_IN_NR_BITS
#define ARRAY_ALUCOM_XSEL_POS_UPPER                           \
    ARRAY_ALUCOM_CR_IN_NR_BITS + ARRAY_ALUCOM_ALUFUNC_NR_BITS \
        + ARRAY_ALUCOM_XSEL_NR_BITS - 1
#define ARRAY_ALUCOM_XSEL_POS_LOWER \
    ARRAY_ALUCOM_CR_IN_NR_BITS + ARRAY_ALUCOM_ALUFUNC_NR_BITS
#define ARRAY_ALUCOM_YSEL_POS_UPPER                           \
    ARRAY_ALUCOM_CR_IN_NR_BITS + ARRAY_ALUCOM_ALUFUNC_NR_BITS \
        + ARRAY_ALUCOM_XSEL_NR_BITS + ARRAY_ALUCOM_YSEL_NR_BITS - 1
#define ARRAY_ALUCOM_YSEL_POS_LOWER \
    ARRAY_ALUCOM_CR_IN_NR_BITS + ARRAY_ALUCOM_ALUFUNC_NR_BITS + ARRAY_ALUCOM_XSEL_NR_BITS
#define ARRAY_ALUCOM_ZSEL_POS_UPPER                             \
    ARRAY_ALUCOM_CR_IN_NR_BITS + ARRAY_ALUCOM_ALUFUNC_NR_BITS   \
        + ARRAY_ALUCOM_XSEL_NR_BITS + ARRAY_ALUCOM_YSEL_NR_BITS \
        + ARRAY_ALUCOM_ZSEL_NR_BITS - 1
#define ARRAY_ALUCOM_ZSEL_POS_LOWER                           \
    ARRAY_ALUCOM_CR_IN_NR_BITS + ARRAY_ALUCOM_ALUFUNC_NR_BITS \
        + ARRAY_ALUCOM_XSEL_NR_BITS + ARRAY_ALUCOM_YSEL_NR_BITS
#define ARRAY_ALUCOM_SRC_POS_UPPER                              \
    ARRAY_ALUCOM_CR_IN_NR_BITS + ARRAY_ALUCOM_ALUFUNC_NR_BITS   \
        + ARRAY_ALUCOM_XSEL_NR_BITS + ARRAY_ALUCOM_YSEL_NR_BITS \
        + ARRAY_ALUCOM_ZSEL_NR_BITS + ARRAY_ALUCOM_SRC_NR_BITS - 1
#define ARRAY_ALUCOM_SRC_POS_LOWER                              \
    ARRAY_ALUCOM_CR_IN_NR_BITS + ARRAY_ALUCOM_ALUFUNC_NR_BITS   \
        + ARRAY_ALUCOM_XSEL_NR_BITS + ARRAY_ALUCOM_YSEL_NR_BITS \
        + ARRAY_ALUCOM_ZSEL_NR_BITS
#define ARRAY_ALUCOM_OPMODE_POS_UPPER                                                 \
    ARRAY_ALUCOM_XSEL_NR_BITS + ARRAY_ALUCOM_YSEL_NR_BITS + ARRAY_ALUCOM_ZSEL_NR_BITS \
        + ARRAY_ALUCOM_CR_IN_NR_BITS + ARRAY_ALUCOM_ALUFUNC_NR_BITS - 1
#define ARRAY_ALUCOM_OPMODE_POS_LOWER \
    ARRAY_ALUCOM_CR_IN_NR_BITS + ARRAY_ALUCOM_ALUFUNC_NR_BITS

#define ARRAY_ALUCOM_CR_IN_POS    \
    ARRAY_ALUCOM_CR_IN_POS_UPPER: \
    ARRAY_ALUCOM_CR_IN_POS_LOWER
#define ARRAY_ALUCOM_ALUFUNC_POS    \
    ARRAY_ALUCOM_ALUFUNC_POS_UPPER: \
    ARRAY_ALUCOM_ALUFUNC_POS_LOWER
#define ARRAY_ALUCOM_XSEL_POS    \
    ARRAY_ALUCOM_XSEL_POS_UPPER: \
    ARRAY_ALUCOM_XSEL_POS_LOWER
#define ARRAY_ALUCOM_YSEL_POS    \
    ARRAY_ALUCOM_YSEL_POS_UPPER: \
    ARRAY_ALUCOM_YSEL_POS_LOWER
#define ARRAY_ALUCOM_ZSEL_POS    \
    ARRAY_ALUCOM_ZSEL_POS_UPPER: \
    ARRAY_ALUCOM_ZSEL_POS_LOWER
#define ARRAY_ALUCOM_SRC_POS    \
    ARRAY_ALUCOM_SRC_POS_UPPER: \
    ARRAY_ALUCOM_SRC_POS_LOWER
#define ARRAY_ALUCOM_OPMODE_POS    \
    ARRAY_ALUCOM_OPMODE_POS_UPPER: \
    ARRAY_ALUCOM_OPMODE_POS_LOWER

#define ARRAY_ALUCOM_NR_BITS                                                             \
    (ARRAY_ALUCOM_CR_IN_NR_BITS + ARRAY_ALUCOM_ALUFUNC_NR_BITS                           \
     + ARRAY_ALUCOM_XSEL_NR_BITS + ARRAY_ALUCOM_YSEL_NR_BITS + ARRAY_ALUCOM_ZSEL_NR_BITS \
     + ARRAY_ALUCOM_SRC_NR_BITS)
...
#define CTRL_ALUCOM_ALUFUNC_POS_UPPER \
    CTRL_ALUCOM_CR_IN_NR_BITS + CTRL_ALUCOM_ALUFUNC_NR_BITS - 1
#define CTRL_ALUCOM_ALUFUNC_POS_LOWER CTRL_ALUCOM_CR_IN_NR_BITS
#define CTRL_ALUCOM_XSEL_POS_UPPER \
    CTRL_ALUCOM_CR_IN_NR_BITS + CTRL_ALUCOM_ALUFUNC_NR_BITS + CTRL_ALUCOM_XSEL_NR_BITS - 1
#define CTRL_ALUCOM_XSEL_POS_LOWER CTRL_ALUCOM_CR_IN_NR_BITS + CTRL_ALUCOM_ALUFUNC_NR_BITS
#define CTRL_ALUCOM_YSEL_POS_UPPER                                                     \
    CTRL_ALUCOM_CR_IN_NR_BITS + CTRL_ALUCOM_ALUFUNC_NR_BITS + CTRL_ALUCOM_XSEL_NR_BITS \
        + CTRL_ALUCOM_YSEL_NR_BITS - 1
#define CTRL_ALUCOM_YSEL_POS_LOWER \
    CTRL_ALUCOM_CR_IN_NR_BITS + CTRL_ALUCOM_ALUFUNC_NR_BITS + CTRL_ALUCOM_XSEL_NR_BITS
#define CTRL_ALUCOM_ZSEL_POS_UPPER                                                     \
    CTRL_ALUCOM_CR_IN_NR_BITS + CTRL_ALUCOM_ALUFUNC_NR_BITS + CTRL_ALUCOM_XSEL_NR_BITS \
        + CTRL_ALUCOM_YSEL_NR_BITS + CTRL_ALUCOM_ZSEL_NR_BITS - 1
#define CTRL_ALUCOM_ZSEL_POS_LOWER                                                     \
    CTRL_ALUCOM_CR_IN_NR_BITS + CTRL_ALUCOM_ALUFUNC_NR_BITS + CTRL_ALUCOM_XSEL_NR_BITS \
        + CTRL_ALUCOM_YSEL_NR_BITS
#define CTRL_ALUCOM_OPMODE_POS_UPPER                                               \
    CTRL_ALUCOM_XSEL_NR_BITS + CTRL_ALUCOM_YSEL_NR_BITS + CTRL_ALUCOM_ZSEL_NR_BITS \
        + CTRL_ALUCOM_CR_IN_NR_BITS + CTRL_ALUCOM_ALUFUNC_NR_BITS - 1
#define CTRL_ALUCOM_OPMODE_POS_LOWER \
    CTRL_ALUCOM_CR_IN_NR_BITS + CTRL_ALUCOM_ALUFUNC_NR_BITS

#define CTRL_ALUCOM_CR_IN_POS    \
    CTRL_ALUCOM_CR_IN_POS_UPPER: \
    CTRL_ALUCOM_CR_IN_POS_LOWER
#define CTRL_ALUCOM_ALUFUNC_POS    \
    CTRL_ALUCOM_ALUFUNC_POS_UPPER: \
    CTRL_ALUCOM_ALUFUNC_POS_LOWER
#define CTRL_ALUCOM_XSEL_POS    \
    CTRL_ALUCOM_XSEL_POS_UPPER: \
    CTRL_ALUCOM_XSEL_POS_LOWER
#define CTRL_ALUCOM_YSEL_POS    \
    CTRL_ALUCOM_YSEL_POS_UPPER: \
    CTRL_ALUCOM_YSEL_POS_LOWER
#define CTRL_ALUCOM_ZSEL_POS    \
    CTRL_ALUCOM_ZSEL_POS_UPPER: \
    CTRL_ALUCOM_ZSEL_POS_LOWER
#define CTRL_ALUCOM_OPMODE_POS    \
    CTRL_ALUCOM_OPMODE_POS_UPPER: \
    CTRL_ALUCOM_OPMODE_POS_LOWER

#define CTRL_ALUCOM_NR_BITS                                                             \
    (CTRL_ALUCOM_CR_IN_NR_BITS + CTRL_ALUCOM_ALUFUNC_NR_BITS + CTRL_ALUCOM_XSEL_NR_BITS \
     + CTRL_ALUCOM_YSEL_NR_BITS + CTRL_ALUCOM_ZSEL_NR_BITS)
...
#define FLOAT_SGN_LOC_UPPER \
    FLOAT_SGN_NR_BITS + FLOAT_EXPONENT_NR_BITS + FLOAT_FRACTIONAL_NR_BITS - 1
#define FLOAT_SGN_LOC_LOWER FLOAT_EXPONENT_NR_BITS + FLOAT_FRACTIONAL_NR_BITS

#define FLOAT_FRACTIONAL_LOC    \
    FLOAT_FRACTIONAL_LOC_UPPER: \
    FLOAT_FRACTIONAL_LOC_LOWER
#define FLOAT_EXPONENT_LOC    \
    FLOAT_EXPONENT_LOC_UPPER: \
    FLOAT_EXPONENT_LOC_LOWER
#define FLOAT_SGN_LOC    \
    FLOAT_SGN_LOC_UPPER: \
    FLOAT_SGN_LOC_LOWER
...
#define FLOAT_OPERATIONS_NR_BITS (log2(FLOAT_OPERATIONS) + 1)
...
#define FLOAT_COMMAND_NR_BITS (log2(FLOAT_COMMAND_do_EXP_ADJUST_w_MEM_PRIOENC + 1) + 1)

#define FLOAT_ARRAY_MANTISSA_SHIFT_AMOUNT_SIZE (log2(DATA_SIZE))
#define FLOAT_CTRL_MANTISSA_SHIFT_AMOUNT_SIZE  (log2(DATA_SIZE_C))
...
#define FLOAT_EFFECTIVE_OPERATION_DSP_carry_in_LOC_UPPER \
    FLOAT_EFFECTIVE_OPERATION_DSP_carry_in_SIZE - 1
#define FLOAT_EFFECTIVE_OPERATION_DSP_carry_in_LOC_LOWER 0
#define FLOAT_EFFECTIVE_OPERATION_DSP_carry_in_LOC    \
...
#define FLOAT_EFFECTIVE_OPERATION_alucom_LOC_UPPER                                      \
    FLOAT_EFFECTIVE_OPERATION_alucom_SIZE + FLOAT_EFFECTIVE_OPERATION_DSP_carry_in_SIZE \
        - 1
#define FLOAT_EFFECTIVE_OPERATION_alucom_LOC_LOWER \
    FLOAT_EFFECTIVE_OPERATION_DSP_carry_in_SIZE
#define FLOAT_EFFECTIVE_OPERATION_alucom_LOC    \
    FLOAT_EFFECTIVE_OPERATION_alucom_LOC_UPPER: \
    FLOAT_EFFECTIVE_OPERATION_alucom_LOC_LOWER

#define FLOAT_EFFECTIVE_OPERATION_ADD(x, delimiter) \
    "x##delimiter##d0" // x = FLOAT_EFFECTIVE_OPERATION_SIZE_unguarded
#define FLOAT_EFFECTIVE_OPERATION_SUB(x, delimiter) \
    "x##delimiter##d6" // x = FLOAT_EFFECTIVE_OPERATION_SIZE_unguarded
#define FLOAT_EFFECTIVE_OPERATION_RSUB(x, delimiter) \
    "x##delimiter##d3" // x = FLOAT_EFFECTIVE_OPERATION_SIZE_unguarded
...
#define INSTR_FLOAT_FP_COMMAND_VALUE_LOC    \
...
#define ARRAY_GLOBAL_SR_CMD_MOVE_RIGHT_W_BOOL_ZERO \
    (ARRAY_GLOBAL_SR_CMD_MOVE_LEFT_WO_BOOL + 1)
#define ARRAY_GLOBAL_SR_CMD_MOVE_LEFT_W_BOOL_ZERO \
    (ARRAY_GLOBAL_SR_CMD_MOVE_RIGHT_W_BOOL_ZERO + 1)
#define ARRAY_GLOBAL_SR_CMD_MOVE_RIGHT_W_BOOL_HOLD \
    (ARRAY_GLOBAL_SR_CMD_MOVE_LEFT_W_BOOL_ZERO + 1)
#define ARRAY_GLOBAL_SR_CMD_MOVE_LEFT_W_BOOL_HOLD \
    (ARRAY_GLOBAL_SR_CMD_MOVE_RIGHT_W_BOOL_HOLD + 1)
...
#define ARRAY_GLOBAL_SR_CMD_NR_BITS      (log2(ARRAY_GLOBAL_SR_CMD_NR_FUNCTIONS) + 1)

#define ARRAY_GLOBAL_SR_RIGHT_CELL_SEL_DONT_CARE 0
#define ARRAY_GLOBAL_SR_RIGHT_CELL_SEL_ROTATE    (0)
#define ARRAY_GLOBAL_SR_RIGHT_CELL_SEL_INSERT_from_CTRL \
    (ARRAY_GLOBAL_SR_RIGHT_CELL_SEL_ROTATE + 1)
#define ARRAY_GLOBAL_SR_RIGHT_CELL_SEL_INSERT_REDUCTION_out \
    (ARRAY_GLOBAL_SR_RIGHT_CELL_SEL_INSERT_from_CTRL + 1)
#define ARRAY_GLOBAL_SR_RIGHT_CELL_SEL_ZERO \
    (ARRAY_GLOBAL_SR_RIGHT_CELL_SEL_INSERT_REDUCTION_out + 1)
#define ARRAY_GLOBAL_SR_LEFT_CELL_SEL_DONT_CARE 0
#define ARRAY_GLOBAL_SR_LEFT_CELL_SEL_ROTATE    (0)
#define ARRAY_GLOBAL_SR_LEFT_CELL_SEL_INSERT_from_CTRL \
    (ARRAY_GLOBAL_SR_LEFT_CELL_SEL_ROTATE + 1)
#define ARRAY_GLOBAL_SR_LEFT_CELL_SEL_INSERT_REDUCTION_out \
    (ARRAY_GLOBAL_SR_LEFT_CELL_SEL_INSERT_from_CTRL + 1)
#define ARRAY_GLOBAL_SR_LEFT_CELL_SEL_ZERO \
    (ARRAY_GLOBAL_SR_LEFT_CELL_SEL_INSERT_REDUCTION_out + 1)
// ^ used for the loose inputs at the leftmost and rightmost cells in the array

#define ARRAY_GLOBAL_SR_RIGHT_CELL_SEL_NR_FUNCTIONS \
    (ARRAY_GLOBAL_SR_RIGHT_CELL_SEL_ZERO + 1)
#define ARRAY_GLOBAL_SR_RIGHT_CELL_SEL_NR_BITS \
    (log2(ARRAY_GLOBAL_SR_RIGHT_CELL_SEL_NR_FUNCTIONS) + 1)
#define ARRAY_GLOBAL_SR_LEFT_CELL_SEL_NR_FUNCTIONS \
    (ARRAY_GLOBAL_SR_LEFT_CELL_SEL_ZERO + 1)
#define ARRAY_GLOBAL_SR_LEFT_CELL_SEL_NR_BITS \
...
#define CTRL_CLOCK_CYCLE_COUNTER_STATE_RUN_W_HALT \
    (CTRL_CLOCK_CYCLE_COUNTER_STATE_STOP + 1)
#define CTRL_CLOCK_CYCLE_COUNTER_STATE_RUN_WO_HALT \
    (CTRL_CLOCK_CYCLE_COUNTER_STATE_RUN_W_HALT + 1)

#define CTRL_CLOCK_CYCLE_COUNTER_STATE_NR_FUNCTIONS \
    (CTRL_CLOCK_CYCLE_COUNTER_STATE_RUN_WO_HALT + 1)
#define CTRL_CLOCK_CYCLE_COUNTER_STATE_NR_BITS \
...
#define NET_CELL_TYPE_0_MUX0_INPUT_1_SEL_VALUE \
    (NET_CELL_TYPE_0_MUX0_INPUT_0_SEL_VALUE + NET_CELL_TYPE_0_NEED_MUX0_INPUT_1)
#define NET_CELL_TYPE_0_MUX0_INPUT_ADDER_SEL_VALUE \
    (NET_CELL_TYPE_0_MUX0_INPUT_1_SEL_VALUE + NET_CELL_TYPE_0_NEED_MUX0_INPUT_ADDER)
#define NET_CELL_TYPE_0_MUX0_INPUT_BITWISE_SEL_VALUE \
    (NET_CELL_TYPE_0_MUX0_INPUT_ADDER_SEL_VALUE + NET_CELL_TYPE_0_NEED_MUX0_INPUT_BITWISE)
#define NET_CELL_TYPE_0_MUX1_INPUT_0_SEL_VALUE (0)
#define NET_CELL_TYPE_0_MUX1_INPUT_1_SEL_VALUE \
    (NET_CELL_TYPE_0_MUX1_INPUT_0_SEL_VALUE + NET_CELL_TYPE_0_NEED_MUX1_INPUT_1)
#define NET_CELL_TYPE_0_MUX1_INPUT_ADDER_SEL_VALUE \
    (NET_CELL_TYPE_0_MUX1_INPUT_1_SEL_VALUE + NET_CELL_TYPE_0_NEED_MUX1_INPUT_ADDER)
#define NET_CELL_TYPE_0_MUX1_INPUT_BITWISE_SEL_VALUE \
    (NET_CELL_TYPE_0_MUX1_INPUT_ADDER_SEL_VALUE + NET_CELL_TYPE_0_NEED_MUX1_INPUT_BITWISE)
#define NET_CELL_TYPE_1_MUX0_INPUT_0_SEL_VALUE (0)
#define NET_CELL_TYPE_1_MUX0_INPUT_1_SEL_VALUE \
    (NET_CELL_TYPE_1_MUX0_INPUT_0_SEL_VALUE + NET_CELL_TYPE_1_NEED_MUX0_INPUT_1)
#define NET_CELL_TYPE_1_MUX0_INPUT_ADDER_SEL_VALUE \
    (NET_CELL_TYPE_1_MUX0_INPUT_1_SEL_VALUE + NET_CELL_TYPE_1_NEED_MUX0_INPUT_ADDER)
#define NET_CELL_TYPE_1_MUX0_INPUT_BITWISE_SEL_VALUE \
    (NET_CELL_TYPE_1_MUX0_INPUT_ADDER_SEL_VALUE + NET_CELL_TYPE_1_NEED_MUX0_INPUT_BITWISE)
#define NET_CELL_TYPE_1_MUX1_INPUT_0_SEL_VALUE (0)
#define NET_CELL_TYPE_1_MUX1_INPUT_1_SEL_VALUE \
    (NET_CELL_TYPE_1_MUX1_INPUT_0_SEL_VALUE + NET_CELL_TYPE_1_NEED_MUX1_INPUT_1)
#define NET_CELL_TYPE_1_MUX1_INPUT_ADDER_SEL_VALUE \
    (NET_CELL_TYPE_1_MUX1_INPUT_1_SEL_VALUE + NET_CELL_TYPE_1_NEED_MUX1_INPUT_ADDER)
#define NET_CELL_TYPE_1_MUX1_INPUT_BITWISE_SEL_VALUE \
    (NET_CELL_TYPE_1_MUX1_INPUT_ADDER_SEL_VALUE + NET_CELL_TYPE_1_NEED_MUX1_INPUT_BITWISE)
#define NET_CELL_TYPE_2_MUX0_INPUT_0_SEL_VALUE (0)
#define NET_CELL_TYPE_2_MUX0_INPUT_1_SEL_VALUE \
    (NET_CELL_TYPE_2_MUX0_INPUT_0_SEL_VALUE + NET_CELL_TYPE_2_NEED_MUX0_INPUT_1)
#define NET_CELL_TYPE_2_MUX0_INPUT_ADDER_SEL_VALUE \
    (NET_CELL_TYPE_2_MUX0_INPUT_1_SEL_VALUE + NET_CELL_TYPE_2_NEED_MUX0_INPUT_ADDER)
#define NET_CELL_TYPE_2_MUX0_INPUT_BITWISE_SEL_VALUE \
    (NET_CELL_TYPE_2_MUX0_INPUT_ADDER_SEL_VALUE + NET_CELL_TYPE_2_NEED_MUX0_INPUT_BITWISE)
#define NET_CELL_TYPE_2_MUX1_INPUT_0_SEL_VALUE (0)
#define NET_CELL_TYPE_2_MUX1_INPUT_1_SEL_VALUE \
    (NET_CELL_TYPE_2_MUX1_INPUT_0_SEL_VALUE + NET_CELL_TYPE_2_NEED_MUX1_INPUT_1)
#define NET_CELL_TYPE_2_MUX1_INPUT_ADDER_SEL_VALUE \
    (NET_CELL_TYPE_2_MUX1_INPUT_1_SEL_VALUE + NET_CELL_TYPE_2_NEED_MUX1_INPUT_ADDER)
#define NET_CELL_TYPE_2_MUX1_INPUT_BITWISE_SEL_VALUE \
    (NET_CELL_TYPE_2_MUX1_INPUT_ADDER_SEL_VALUE + NET_CELL_TYPE_2_NEED_MUX1_INPUT_BITWISE)
#define NET_CELL_TYPE_3_MUX0_INPUT_0_SEL_VALUE (0)
#define NET_CELL_TYPE_3_MUX0_INPUT_1_SEL_VALUE \
    (NET_CELL_TYPE_3_MUX0_INPUT_0_SEL_VALUE + NET_CELL_TYPE_3_NEED_MUX0_INPUT_1)
#define NET_CELL_TYPE_3_MUX0_INPUT_ADDER_SEL_VALUE \
    (NET_CELL_TYPE_3_MUX0_INPUT_1_SEL_VALUE + NET_CELL_TYPE_3_NEED_MUX0_INPUT_ADDER)
#define NET_CELL_TYPE_3_MUX0_INPUT_BITWISE_SEL_VALUE \
    (NET_CELL_TYPE_3_MUX0_INPUT_ADDER_SEL_VALUE + NET_CELL_TYPE_3_NEED_MUX0_INPUT_BITWISE)
#define NET_CELL_TYPE_3_MUX1_INPUT_0_SEL_VALUE (0)
#define NET_CELL_TYPE_3_MUX1_INPUT_1_SEL_VALUE \
    (NET_CELL_TYPE_3_MUX1_INPUT_0_SEL_VALUE + NET_CELL_TYPE_3_NEED_MUX1_INPUT_1)
#define NET_CELL_TYPE_3_MUX1_INPUT_ADDER_SEL_VALUE \
    (NET_CELL_TYPE_3_MUX1_INPUT_1_SEL_VALUE + NET_CELL_TYPE_3_NEED_MUX1_INPUT_ADDER)
#define NET_CELL_TYPE_3_MUX1_INPUT_BITWISE_SEL_VALUE \
    (NET_CELL_TYPE_3_MUX1_INPUT_ADDER_SEL_VALUE + NET_CELL_TYPE_3_NEED_MUX1_INPUT_BITWISE)
#define NET_CELL_TYPE_4_MUX0_INPUT_0_SEL_VALUE (0)
#define NET_CELL_TYPE_4_MUX0_INPUT_1_SEL_VALUE \
    (NET_CELL_TYPE_4_MUX0_INPUT_0_SEL_VALUE + NET_CELL_TYPE_4_NEED_MUX0_INPUT_1)
#define NET_CELL_TYPE_4_MUX0_INPUT_ADDER_SEL_VALUE \
    (NET_CELL_TYPE_4_MUX0_INPUT_1_SEL_VALUE + NET_CELL_TYPE_4_NEED_MUX0_INPUT_ADDER)
#define NET_CELL_TYPE_4_MUX0_INPUT_BITWISE_SEL_VALUE \
    (NET_CELL_TYPE_4_MUX0_INPUT_ADDER_SEL_VALUE + NET_CELL_TYPE_4_NEED_MUX0_INPUT_BITWISE)
#define NET_CELL_TYPE_4_MUX1_INPUT_0_SEL_VALUE (0)
#define NET_CELL_TYPE_4_MUX1_INPUT_1_SEL_VALUE \
    (NET_CELL_TYPE_4_MUX1_INPUT_0_SEL_VALUE + NET_CELL_TYPE_4_NEED_MUX1_INPUT_1)
#define NET_CELL_TYPE_4_MUX1_INPUT_ADDER_SEL_VALUE \
    (NET_CELL_TYPE_4_MUX1_INPUT_1_SEL_VALUE + NET_CELL_TYPE_4_NEED_MUX1_INPUT_ADDER)
#define NET_CELL_TYPE_4_MUX1_INPUT_BITWISE_SEL_VALUE \
    (NET_CELL_TYPE_4_MUX1_INPUT_ADDER_SEL_VALUE + NET_CELL_TYPE_4_NEED_MUX1_INPUT_BITWISE)

// each cell type - nr inputs
#define NET_CELL_TYPE_0_NR_MUX0_INPUTS                                     \
    (NET_CELL_TYPE_0_NEED_MUX0_INPUT_0 + NET_CELL_TYPE_0_NEED_MUX0_INPUT_1 \
     + NET_CELL_TYPE_0_NEED_MUX0_INPUT_ADDER + NET_CELL_TYPE_0_NEED_MUX0_INPUT_BITWISE)

#define NET_CELL_TYPE_0_NR_MUX1_INPUTS                                     \
    (NET_CELL_TYPE_0_NEED_MUX1_INPUT_0 + NET_CELL_TYPE_0_NEED_MUX1_INPUT_1 \
     + NET_CELL_TYPE_0_NEED_MUX1_INPUT_ADDER + NET_CELL_TYPE_0_NEED_MUX1_INPUT_BITWISE)

#define NET_CELL_TYPE_1_NR_MUX0_INPUTS                                     \
    (NET_CELL_TYPE_1_NEED_MUX0_INPUT_0 + NET_CELL_TYPE_1_NEED_MUX0_INPUT_1 \
     + NET_CELL_TYPE_1_NEED_MUX0_INPUT_ADDER + NET_CELL_TYPE_1_NEED_MUX0_INPUT_BITWISE)

#define NET_CELL_TYPE_1_NR_MUX1_INPUTS                                     \
    (NET_CELL_TYPE_1_NEED_MUX1_INPUT_0 + NET_CELL_TYPE_1_NEED_MUX1_INPUT_1 \
     + NET_CELL_TYPE_1_NEED_MUX1_INPUT_ADDER + NET_CELL_TYPE_1_NEED_MUX1_INPUT_BITWISE)

#define NET_CELL_TYPE_2_NR_MUX0_INPUTS                                     \
    (NET_CELL_TYPE_2_NEED_MUX0_INPUT_0 + NET_CELL_TYPE_2_NEED_MUX0_INPUT_1 \
     + NET_CELL_TYPE_2_NEED_MUX0_INPUT_ADDER + NET_CELL_TYPE_2_NEED_MUX0_INPUT_BITWISE)

#define NET_CELL_TYPE_2_NR_MUX1_INPUTS                                     \
    (NET_CELL_TYPE_2_NEED_MUX1_INPUT_0 + NET_CELL_TYPE_2_NEED_MUX1_INPUT_1 \
     + NET_CELL_TYPE_2_NEED_MUX1_INPUT_ADDER + NET_CELL_TYPE_2_NEED_MUX1_INPUT_BITWISE)

#define NET_CELL_TYPE_3_NR_MUX0_INPUTS                                     \
    (NET_CELL_TYPE_3_NEED_MUX0_INPUT_0 + NET_CELL_TYPE_3_NEED_MUX0_INPUT_1 \
     + NET_CELL_TYPE_3_NEED_MUX0_INPUT_ADDER + NET_CELL_TYPE_3_NEED_MUX0_INPUT_BITWISE)

#define NET_CELL_TYPE_3_NR_MUX1_INPUTS                                     \
    (NET_CELL_TYPE_3_NEED_MUX1_INPUT_0 + NET_CELL_TYPE_3_NEED_MUX1_INPUT_1 \
     + NET_CELL_TYPE_3_NEED_MUX1_INPUT_ADDER + NET_CELL_TYPE_3_NEED_MUX1_INPUT_BITWISE)

#define NET_CELL_TYPE_4_NR_MUX0_INPUTS                                     \
    (NET_CELL_TYPE_4_NEED_MUX0_INPUT_0 + NET_CELL_TYPE_4_NEED_MUX0_INPUT_1 \
     + NET_CELL_TYPE_4_NEED_MUX0_INPUT_ADDER + NET_CELL_TYPE_4_NEED_MUX0_INPUT_BITWISE)

#define NET_CELL_TYPE_4_NR_MUX1_INPUTS                                     \
    (NET_CELL_TYPE_4_NEED_MUX1_INPUT_0 + NET_CELL_TYPE_4_NEED_MUX1_INPUT_1 \
