...
//-------------------------------------------------------------------------------------
void GoldenModelTarget::runDebug(
...
//-------------------------------------------------------------------------------------
void GoldenModelTarget::readControllerData(
    uint32_t _address,
    uint32_t* _data,
    uint32_t _lineStart,
    uint32_t _lineStop,
...
//-------------------------------------------------------------------------------------
void GoldenModelTarget::writeControllerData(
    uint32_t _address,
    uint32_t* _data,
    uint32_t _lineStart,
    uint32_t _lineStop,
...
//-------------------------------------------------------------------------------------
void GoldenModelTarget::readMatrixArray(
...
//-------------------------------------------------------------------------------------
void GoldenModelTarget::writeMatrixArray(
    uint32_t _accMemStart,
    uint32_t* _ramMatrix,
    uint32_t _ramTotalLines,
    uint32_t _ramTotalColumns,
