...
void XpuTestBench::tb_init()
{
    ...
    std::string axi_lite_program_file_path(SIMULATION_FILE_PATH_BACKSTEPS +
                                           "io_simulation_data/program_file/program_file_" +
    ...
    std::string axi_lite_program_file_combined_path(SIMULATION_FILE_PATH_BACKSTEPS +
    ...
    std::string axi_lite_function_arguments_file_path(SIMULATION_FILE_PATH_BACKSTEPS +
    ...
    std::string axi_stream_in_file_path(SIMULATION_FILE_PATH_BACKSTEPS +
                                        "io_simulation_data/input/axi_stream_input_" +
                                        simulation_accelerator_setup +
                                        "_" +
                                        SIMULATION_FUNCTION_PERFORMED +
                                        "_" +
    ...
    std::string axi_stream_out_file_path(SIMULATION_FILE_PATH_BACKSTEPS +
