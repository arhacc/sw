...
public class AsmParser extends Parser {
	...
	public static final int
		...
		T__245=246, LOG2=247, SQRT=248, LPAREN=249, RPAREN=250, PLUS=251, MINUS=252, 
		TIMES=253, DIV=254, POINT=255, POW=256, PI=257, ARCHITECTUREID=258, DATA=259, 
		FILEPATH=260, INCLUDE=261, FUNC=262, ENDFUNC=263, MACRO=264, ENDMACRO=265, 
		DEFINE=266, CONST=267, SIGN=268, OP_DUAL=269, OP_UNARY=270, NAME=271, 
		NUMBER=272, HEXADECIMAL1=273, HEXADECIMAL2=274, STRING=275, TS=276, EOL=277, 
		COMMA=278, COMMENT=279;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'macro'", "'endmacro'", "'define'", "'const'", null, null, "'log'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, "LOG2", "SQRT", "LPAREN", "RPAREN", 
			"PLUS", "MINUS", "TIMES", "DIV", "POINT", "POW", "PI", "ARCHITECTUREID", 
			"DATA", "FILEPATH", "INCLUDE", "FUNC", "ENDFUNC", "MACRO", "ENDMACRO", 
			"DEFINE", "CONST", "SIGN", "OP_DUAL", "OP_UNARY", "NAME", "NUMBER", "HEXADECIMAL1", 
			"HEXADECIMAL2", "STRING", "TS", "EOL", "COMMA", "COMMENT"
		};
	}
	...
	public final ParseContext parse() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & -2L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & -1L) != 0) || ((((_la - 128)) & ~0x3f) == 0 && ((1L << (_la - 128)) & -1L) != 0) || ((((_la - 192)) & ~0x3f) == 0 && ((1L << (_la - 192)) & 255L) != 0) || ((((_la - 258)) & ~0x3f) == 0 && ((1L << (_la - 258)) & 9211L) != 0) );
			setState(77);
			match(EOF);
			}
		}
	...
	public final ControllerOpcode1Context controllerOpcode1() throws RecognitionException {
		...
		try {
			...
			setState(120);
			_la = _input.LA(1);
			if ( !(((((_la - 82)) & ~0x3f) == 0 && ((1L << (_la - 82)) & -1L) != 0) || ((((_la - 146)) & ~0x3f) == 0 && ((1L << (_la - 146)) & 2147483647L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final ControllerOpcode2Context controllerOpcode2() throws RecognitionException {
		...
		try {
			...
			setState(122);
			_la = _input.LA(1);
			if ( !(((((_la - 177)) & ~0x3f) == 0 && ((1L << (_la - 177)) & 8191L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final ControllerOpcode3Context controllerOpcode3() throws RecognitionException {
		...
		try {
			...
			setState(124);
			_la = _input.LA(1);
			if ( !(((((_la - 190)) & ~0x3f) == 0 && ((1L << (_la - 190)) & 1023L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final ArrayOpcode0Context arrayOpcode0() throws RecognitionException {
		...
		try {
			...
			setState(132);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 562949953421310L) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & 249L) != 0) || ((((_la - 200)) & ~0x3f) == 0 && ((1L << (_la - 200)) & 2199023255551L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final ArrayOpcode1Context arrayOpcode1() throws RecognitionException {
		...
		try {
			...
			setState(134);
			_la = _input.LA(1);
			if ( !(((((_la - 82)) & ~0x3f) == 0 && ((1L << (_la - 82)) & -1L) != 0) || ((((_la - 146)) & ~0x3f) == 0 && ((1L << (_la - 146)) & 197165055L) != 0) || ((((_la - 241)) & ~0x3f) == 0 && ((1L << (_la - 241)) & 31L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final ParametersInstantiationContext parametersInstantiation() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 247)) & ~0x3f) == 0 && ((1L << (_la - 247)) & 50331703L) != 0)) {
				{
				setState(228);
				expression();
				}
