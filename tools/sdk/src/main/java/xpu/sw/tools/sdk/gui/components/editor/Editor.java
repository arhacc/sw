 ...
 * @author marius
 */
public class Editor extends javax.swing.JPanel implements CloseTabListener {
    private Gui gui;
...
//-------------------------------------------------------------------------------------
    private void init(){        
        List<String> _openFiles = sdkConfig.getList(String.class, "open_files");
...
//-------------------------------------------------------------------------------------
    private int addNewTab(File _file){
        EditorTab _editorTab = new EditorTab(gui, context, _file, themeName);
...
//        super.addTab(title, icon, component, tip);
        ...
        if((_openFiles == null ) || (!_openFiles.contains(_openFile))){
            sdkConfig.addProperty("open_files", _openFile);
        }
        return _count;
    }
...
//-------------------------------------------------------------------------------------
    public void closeTab(int _index){
        ...
        sdkConfig.clearProperty("open_files");
        ...
        for (int i = 0; i < _openFiles.size(); i++) {
            ...
            if(!_path.equals(_tabFilePath)){
                sdkConfig.addProperty("open_files", _path);
            }
        }
