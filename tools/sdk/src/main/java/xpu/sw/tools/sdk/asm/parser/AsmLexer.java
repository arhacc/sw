...
public class AsmLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__245", "T__246", "ARCHITECTUREID", "DATA", "FILEPATH", "INCLUDE", 
			"FUNC", "ENDFUNC", "MACRO", "ENDMACRO", "DEFINE", "SIGN", "NAME", "NUMBER", 
			"HEXADECIMAL1", "HEXADECIMAL2", "STRING", "Tab", "Space", "TS", "EOL", 
			"COMMA", "COMMENT"
		};
	}
