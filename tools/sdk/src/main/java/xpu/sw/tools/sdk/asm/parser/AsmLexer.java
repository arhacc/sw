...
public class AsmLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"LPAREN", "RPAREN", "PLUS", "MINUS", "TIMES", "DIV", "POINT", "POW", 
			"PI", "ARCHITECTUREID", "DATA", "FILEPATH", "INCLUDE", "FUNC", "ENDFUNC", 
			"MACRO", "ENDMACRO", "DEFINE", "CONST", "SIGN", "OP_DUAL", "OP_UNARY", 
			"NAME", "NUMBER", "HEXADECIMAL1", "HEXADECIMAL2", "STRING", "Tab", "Space", 
