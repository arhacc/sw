...
public class AsmLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__252", "T__253", "T__254", "T__255", "T__256", "T__257", "LOG2", "SQRT", 
			"CEIL", "FLOOR", "ROUND", "LPAREN", "RPAREN", "PLUS", "MINUS", "TIMES", 
			"DIV", "POINT", "POW", "PI", "ARCHITECTUREID", "DATA", "FILEPATH", "INCLUDE", 
			"FUNC", "ENDFUNC", "MACRO", "ENDMACRO", "DEFINE", "CONST", "SIGN", "NAME", 
			"FLOAT", "DEC", "HEX1", "HEX2", "BIN", "STRING", "Tab", "Space", "TS", 
			"EOL", "COMMA", "COMMENT"
		};
	}
